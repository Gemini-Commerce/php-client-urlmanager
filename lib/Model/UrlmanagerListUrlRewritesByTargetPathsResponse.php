...
/**
 * UrlmanagerListUrlRewritesByTargetPathsResponse Class Doc Comment
 *
 * @category Class
 * @package  GeminiCommerce\Urlmanager
 * @author   OpenAPI Generator team
 ...
 */
class UrlmanagerListUrlRewritesByTargetPathsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'urlmanagerListUrlRewritesByTargetPathsResponse';
    ...
    protected static $openAPITypes = [
        'url_rewrites' => '\GeminiCommerce\Urlmanager\Model\UrlmanagerUrlRewrite[]'
    ];
    ...
    {
        $this->setIfExists('url_rewrites', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets url_rewrites
     *
     * @return \GeminiCommerce\Urlmanager\Model\UrlmanagerUrlRewrite[]|null
     */
    public function getUrlRewrites()
    {
        return $this->container['url_rewrites'];
    }

    /**
     * Sets url_rewrites
     *
     * @param \GeminiCommerce\Urlmanager\Model\UrlmanagerUrlRewrite[]|null $url_rewrites url_rewrites
     *
     * @return self
     */
    public function setUrlRewrites($url_rewrites)
    {
        if (is_null($url_rewrites)) {
            throw new \InvalidArgumentException('non-nullable url_rewrites cannot be null');
        }
        $this->container['url_rewrites'] = $url_rewrites;
