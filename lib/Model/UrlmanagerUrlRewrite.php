...
/**
 * UrlmanagerUrlRewrite Class Doc Comment
 *
 * @category Class
 * @package  GeminiCommerce\Urlmanager
 * @author   OpenAPI Generator team
 ...
 */
class UrlmanagerUrlRewrite implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'urlmanagerUrlRewrite';
    ...
    protected static $openAPITypes = [
        ...
        'request_path' => 'string',
        'target_path' => 'string',
        'redirect_type' => '\GeminiCommerce\Urlmanager\Model\UrlRewriteRedirectType',
        'link_rel' => '\GeminiCommerce\Urlmanager\Model\UrlRewriteLinkRel'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('link_rel', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets context
     *
     * @param string|null $context Context field is part of the key. it's up to whoever is using the url manager to define it. e.g. locale or market or a concatenation of the two if needed.
     *
     * @return self
     */
     ...
     * Sets request_path
     *
     * @param string|null $request_path request_path
     *
     * @return self
     */
     ...
     * Sets target_path
     *
     * @param string|null $target_path target_path
     *
     * @return self
     */
     ...
     * Gets redirect_type
     *
     * @return \GeminiCommerce\Urlmanager\Model\UrlRewriteRedirectType|null
     */
     ...
     * Sets redirect_type
     *
     * @param \GeminiCommerce\Urlmanager\Model\UrlRewriteRedirectType|null $redirect_type redirect_type
     *
     * @return self
     */
     ...
     * Gets link_rel
     *
     * @return \GeminiCommerce\Urlmanager\Model\UrlRewriteLinkRel|null
     */
    public function getLinkRel()
    {
        return $this->container['link_rel'];
    }

    /**
     * Sets link_rel
     *
     * @param \GeminiCommerce\Urlmanager\Model\UrlRewriteLinkRel|null $link_rel link_rel
     *
     * @return self
     */
    ...
    {
        if (is_null($link_rel)) {
            throw new \InvalidArgumentException('non-nullable link_rel cannot be null');
        }
        $this->container['link_rel'] = $link_rel;
