...
/**
 * UrlmanagerListUrlRewritesByTargetPathsRequest Class Doc Comment
 *
 * @category Class
 * @package  GeminiCommerce\Urlmanager
 * @author   OpenAPI Generator team
 ...
 */
class UrlmanagerListUrlRewritesByTargetPathsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'urlmanagerListUrlRewritesByTargetPathsRequest';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('target_paths', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['target_paths'];
    }

    /**
     * Sets target_paths
     *
     * @param string[]|null $target_paths Required.
     *
     * @return self
     */
    public function setTargetPaths($target_paths)
    {
        if (is_null($target_paths)) {
            throw new \InvalidArgumentException('non-nullable target_paths cannot be null');
        }
        $this->container['target_paths'] = $target_paths;
