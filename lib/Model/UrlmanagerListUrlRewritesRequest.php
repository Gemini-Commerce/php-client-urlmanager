...
/**
 * UrlmanagerListUrlRewritesRequest Class Doc Comment
 *
 * @category Class
 * @package  GeminiCommerce\Urlmanager
 * @author   OpenAPI Generator team
 ...
 */
class UrlmanagerListUrlRewritesRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'urlmanagerListUrlRewritesRequest';
    ...
    protected static $openAPITypes = [
        'tenant_id' => 'string',
        'filter' => '\GeminiCommerce\Urlmanager\Model\ListUrlRewritesRequestFilter',
        'page_size' => 'int',
        'page_token' => 'string'
    ];
    ...
    */
     ...
     * Gets filter
     *
     * @return \GeminiCommerce\Urlmanager\Model\ListUrlRewritesRequestFilter|null
     */
     ...
     * Sets filter
     *
     * @param \GeminiCommerce\Urlmanager\Model\ListUrlRewritesRequestFilter|null $filter filter
     *
     * @return self
     */
     ...
     * Sets page_size
     *
     * @param int|null $page_size The maximum number of url rewrites to return. The service may return fewer than this value. If unspecified, at most 10 url rewrites will be returned. The maximum value is 200; values above 200 will be coerced to 200.
     *
     * @return self
     */
     ...
     * Sets page_token
     *
     * @param string|null $page_token A page token, received from a previous `ListUrlRewrites` call. Provide this to retrieve the subsequent page.   When paginating, all other parameters provided to `ListUrlRewrites` must match the call that provided the page token.
     *
     * @return self
     */
