...
/**
 * UrlRewriteRedirectType Class Doc Comment
 *
 * @category Class
 * @package  GeminiCommerce\Urlmanager
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class UrlRewriteRedirectType
{
    /**
     * Possible values of this enum
     */
    public const UNKNOWN = 'RedirectType_UNKNOWN';

    public const OK = 'RedirectType_OK';

    public const PERMANENT = 'RedirectType_PERMANENT';

    public const TEMPORARY = 'RedirectType_TEMPORARY';
